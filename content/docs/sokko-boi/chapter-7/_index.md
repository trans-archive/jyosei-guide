...
饮食费节约的话，可以借到 1 小时 300 日元（18 人民币）左右的房间。
...
日本的嗓音训练和专业的女声训练不同，目的仅仅是为了让男声或女声更好听，接下来下文中提到的嗓音训练师进行的则为日本通常的嗓音训练方法，类似于美声
...
实际价格为 1000 日元多的较多，虽然性能较差，但是仅仅是作为趣味的范围来讲已经有着足够的性能了。
作为练习用的器材推荐这边的动圈式麦克风。
